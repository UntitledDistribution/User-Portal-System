...
def Show_Pro(root, eml):
    ...
    PButton = ctk.CTkButton(PFrame, image=Ppfp, text="", fg_color="transparent", bg_color="transparent", hover_color="grey", command=Pro.pfp.newPfp)
...
Show_Ban()
Show_Log() # Starts the Debugging Menu, Utilised during program creation for convenience.
